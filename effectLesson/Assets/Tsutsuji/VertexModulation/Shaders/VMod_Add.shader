...
Shader "Tsutsuji/VertexModulation_Add" {
    Properties {
        ...
        _NoiseContrast ("Noise Contrast", Range(0, 1)) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float4 node_4680 = _Time;
                float node_5344_ang = node_4680.g;
                float node_5344_spd = (_NoiseSpeed*3.0);
                float node_5344_cos = cos(node_5344_spd*node_5344_ang);
                float node_5344_sin = sin(node_5344_spd*node_5344_ang);
                float2 node_5344_piv = (float2(sin(node_3443.g),cos(node_3443.g))*0.5+0.5);
                ...
                float2 node_7644 = (node_5344+(node_3443.g*_NoiseSpeed)*float2(0.5,0.5));
...
////// Emissive:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_5344_ang = node_5662.g;
                float node_5344_spd = (_NoiseSpeed*3.0);
                float node_5344_cos = cos(node_5344_spd*node_5344_ang);
                float node_5344_sin = sin(node_5344_spd*node_5344_ang);
                float2 node_5344_piv = (float2(sin(node_3443.g),cos(node_3443.g))*0.5+0.5);
