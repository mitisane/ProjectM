...
////// Lighting:
////// Emissive:
                float4 node_6353 = _Time;
                float2 node_6288 = (i.uv0+node_6353.g*float2(0,-3));
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(node_6288, _MainTex));
