...
////// Lighting:
////// Emissive:
                float4 node_2042 = _Time;
                float2 node_2465 = (i.uv0+node_2042.g*float2(0.5,0));
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(node_2465, _MainTex));
