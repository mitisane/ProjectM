...
Shader "Shader Forge/Shader01" {
    Properties {
        ...
        _node_6360 ("node_6360", Range(0, 1)) = 0.3589744
    }
    SubShader {
        Tags {
...
////// Lighting:
////// Emissive:
                float4 node_6566 = _Time;
                float2 node_8476 = (i.uv0+node_6566.g*float2(0,21));
