...
Shader "Shader Forge/Shader01" {
    Properties {
        ...
        _node_6360 ("node_6360", Range(0, 1)) = 0.1025641
    }
    SubShader {
        Tags {
...
////// Lighting:
////// Emissive:
                float4 node_8938 = _Time;
                float2 node_8476 = (i.uv0+node_8938.g*float2(0,5));
