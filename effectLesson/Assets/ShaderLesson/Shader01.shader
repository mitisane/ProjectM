...
////// Emissive:
                ...
                float2 node_8476 = (i.uv0+node_3946.g*float2(0,1));
                float4 _node_45_var = tex2D(_node_45,TRANSFORM_TEX(node_8476, _node_45));
                float4 node_7279 = _Time;
                float3 emissive = (((1.0 - _node_45_var.rgb)+_node_6360)*((sin((node_7279.g*_node_6855))*0.5+0.5)*_node_2926.rgb));
